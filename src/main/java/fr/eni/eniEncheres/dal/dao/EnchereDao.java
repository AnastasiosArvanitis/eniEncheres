...
public interface EnchereDao {
    ...
    List<Enchere> selectByUtilisateur(Utilisateur utilisateur) throws SQLException, DalException;
    List<Enchere> selectByArticle(Article article) throws SQLException, DalException;
